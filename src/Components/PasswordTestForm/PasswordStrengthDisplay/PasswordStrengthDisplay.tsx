  ...
  return (
    <>
      ...
      <FlexBox justifyContent="center" gap="5px">
        <PasswordStrengthDisplayItem passwordStr={passwordStrength}>Easy</PasswordStrengthDisplayItem>
        <PasswordStrengthDisplayItem passwordStr={passwordStrength}>Medium</PasswordStrengthDisplayItem>
        <PasswordStrengthDisplayItem passwordStr={passwordStrength}>Strong</PasswordStrengthDisplayItem>
      </FlexBox>
    </>
  );
};
